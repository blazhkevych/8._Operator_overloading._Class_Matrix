...
int main()
{
	...
	// В КОНСТРУКТОРАХ ИСПОЛЬЗОВАТЬ списковую инициализацию.
	// // Умножение матриц. - не правильно перемножены матрицы ! Переделать. Добавить проверку по индексу, как в сложениии.
